...
const messages: Record<Locale, Record<SafetyCategory, string>> = {
  "zh-HK": {
    ...
    medical: "卦象不能用於診斷、預後或治療決定。如有需要，請諮詢合資格醫療專業人員。",
    pregnancy: "卦象不能判斷懷孕結果、胎兒性別或醫療風險。請諮詢合資格醫療專業人員。",
    financial: "此結果不是投資、信貸或稅務建議，也不能預測價格。請依據可核實的資料及專業意見作決定。",
    legal: "此結果不能得出法律結論或代替律師意見。如需保障權利或遵守時限，請儘快諮詢合資格法律專業人員。",
    "abuse-or-coercion": "暴力與強迫不是你的錯。如果當下不安全，請先前往安全的地方，再聯絡緊急服務或可信任的支援機構。",
  },
  "zh-CN": {
    "self-harm": "如果你正处于即时危险，请立即联系当地紧急服务，并尽快告诉一位你信任的人。本工具不能评估或处理危机。",
    medical: "卦象不能用于诊断、预后或治疗决定。如有需要，请咨询合格医疗专业人员。",
    pregnancy: "卦象不能判断怀孕结果、胎儿性别或医疗风险。请咨询合格医疗专业人员。",
    financial: "此结果不是投资、信贷或税务建议，也不能预测价格。请依据可核实的信息及专业意见作出决策。",
    legal: "此结果不能得出法律结论或代替律师意见。如需保障权利或遵守时限，请尽快咨询合格法律专业人员。",
    "abuse-or-coercion": "暴力与强迫不是你的错。如果当下不安全，请先前往安全的地方，再联系紧急服务或可信任的支持机构。",
  },
  en: {
