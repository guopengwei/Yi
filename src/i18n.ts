...
const resources = {
  "zh-HK": { translation: {
    ...
    help: { eyebrow: "關於／方法／私隱", title: "把卦象當作一面鏡", body1: "Yi 先依照你選擇的方法生成六爻，再以固定文王卦序對應找出本卦與之卦。相同輸入永遠得到相同事實。", body2: "它不是預言、診斷、投資或法律建議。適合用來整理問題、辨認假設，以及設計下一個可逆的小步驟。", methods: "三種方法都保留由下至上的爻序，並在提交前要求覆核。", privacy: "分享永遠匿名；AI 同意與資料範圍逐次選擇。" },
  ...
  "zh-CN": { translation: {
    ...
    help: { eyebrow: "关于／方法／隐私", title: "把卦象当作一面镜子", body1: "Yi 先按照你选择的方法生成六爻，再以固定文王卦序对应找出本卦与之卦。相同输入永远得到相同事实。", body2: "它不是预言、诊断、投资或法律建议。适合用来整理问题、辨认假设，以及设计下一个可逆的小步骤。", methods: "三种方法都保留由下至上的爻序，并在提交前要求复核。", privacy: "分享永远匿名；AI 同意与数据范围逐次选择。" },
