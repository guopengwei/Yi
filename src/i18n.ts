...
const resources = {
  "zh-HK": { translation: {
    ...
    hero: { eyebrow: "一個安靜、可重現的反思儀式", title: "先把問題，\n放在光裡。", body: "三種經過版本化的起卦方法。卦象由規則確定，AI 只在你明確同意後加入，而且永遠不是預測。", start: "開始起卦", privacy: "你的問題預設不會傳給 AI，也永不出現在分享連結。", caption: "卦象／形態／變化", imageAlt: "暖色晨光中的抽象陶瓷陰陽爻靜物" },
    trust: { deterministic: "確定性結果", reviewed: "提交前覆核", private: "問題預設私密" },
    cast: {
  ...
  "zh-CN": { translation: {
    ...
    hero: { eyebrow: "一个安静、可重现的反思仪式", title: "先把问题，\n放在光里。", body: "三种经过版本化的起卦方法。卦象由规则确定，AI 只在你明确同意后加入，而且永远不是预测。", start: "开始起卦", privacy: "你的问题默认不会传给 AI，也永不出现在分享链接。", caption: "卦象／形态／变化", imageAlt: "暖色晨光中的抽象陶瓷阴阳爻静物" },
    trust: { deterministic: "确定性结果", reviewed: "提交前复核", private: "问题默认私密" },
  ...
  en: { translation: {
    ...
    hero: { eyebrow: "A quiet, reproducible reflection ritual", title: "Place the question\nin the light.", body: "Three versioned casting methods. The reading is fixed by rules; AI joins only with your explicit consent, and never as prediction.", start: "Begin a reading", privacy: "Your question is not sent to AI by default and never appears in a share link.", caption: "HEXAGRAM / FORM / CHANGE", imageAlt: "Abstract ceramic yin and yang lines in warm morning light" },
    trust: { deterministic: "Deterministic result", reviewed: "Review before submit", private: "Private by default" },
