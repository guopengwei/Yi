...
const resources = {
  ...
  "zh-CN": { translation: {
    ...
    specialLine: { nine: "用九", six: "用六" },
    result: { waiting: "结果正在准备", waitingBody: "付款结果只以 Stripe 的已验证通知为准。此页会自动更新。", primary: "本卦", relating: "之卦", movingLines: "动爻", none: "无动爻", facts: "可重现事实", sourcePending: "来源目录待审核", sourceBody: "目前只显示不依赖解读文本的卦象事实。来源解读与来源型 AI 在权利及三语审核完成前保持关闭。", sourceReviewed: "已审核来源目录", sourceReviewedBody: "这次阅读已固定使用具来源、权利状态及三语审核的摘录。只有在你另行同意后才会传给 AI。", reflection: "AI 反思", reflectionQuestions: "值得继续思考", reflectionCautions: "阅读提醒", askReflection: "选择是否加入 AI 反思", archive: "保存这次阅读", archived: "已保存", again: "再起一卦", chat: "围绕这次阅读对话", share: "创建匿名分享" },
