...
export const legalContent: Record<AppLocale, { privacy: LegalDocument; terms: LegalDocument; labels: { privacy: string; terms: string; company: string } }> = {
  "zh-HK": {
    ...
    privacy: {
      ...
      intro: "RICHTIDE LIMITED（「我們」）營運 Yi · 易。本政策說明我們收集哪些個人資料、使用原因、分享對象、保存時間，以及你可如何行使選擇和權利。",
      sections: [
        { title: "我們持有的資料", paragraphs: ["我們可能持有你的姓名、電郵地址、登入及驗證紀錄、語言與顯示設定；你提交的問題、卦象事實、已儲存閱讀、筆記及對話；掛金金額、付款狀態及 Stripe 識別碼；聯絡表格內容；以及防濫用、錯誤及操作記錄。完整付款卡資料由 Stripe 處理，我們不儲存。"] },
        { title: "使用目的", paragraphs: ["我們使用資料來建立及保護帳戶、提供可重現的閱讀、保存你明確選擇的內容、處理掛金、回覆支援、執行用量及安全限制、偵測濫用、維護服務，以及履行適用法律責任。我們不出售個人資料。"] },
        { title: "AI 由你選擇", paragraphs: ["DeepSeek 反思是自願功能。每次使用前，你分別選擇是否傳送卦象事實、已審核來源及原問題。高風險問題會繞過 AI。模型的隱藏推理不會回傳或儲存在瀏覽器。拒絕 AI 不影響確定性結果。"] },
        { title: "服務供應商與跨境處理", paragraphs: ["我們使用 Cloudflare 提供運算、資料庫、保安及電郵；Better Auth 提供認證流程；Stripe 處理付款；Google 及 Microsoft 在你選擇時提供登入；DeepSeek 只處理你明確同意傳送的 AI 資料。這些供應商可能在香港以外處理資料，並受其條款及保安措施約束。我們亦可能在法律要求或保障使用者及服務所必要時披露資料。"] },
        { title: "保存與分享", paragraphs: ["未儲存的訪客閱讀在七日內刪除。匿名分享連結在七日後失效，且不含身份、原問題、筆記或對話。已儲存閱讀、筆記及對話保留至你逐項刪除或關閉帳戶。操作錯誤記錄一般在 90 日後刪除。付款及必要審計資料可按法律、會計、爭議及防詐需要保存較長時間。"] },
        { title: "保安、Cookie 與你的權利", paragraphs: ["我們使用同站 HTTP-only 工作階段、存取控制、加密傳輸及資料最小化。必要 Cookie 用於登入及安全；語言、主題及字體選擇可儲存在裝置。你可在設定中匯出或刪除帳戶，亦可要求查閱或更正個人資料。為保障資料，我們可能核實申請人身份。"] },
        { title: "聯絡與更新", paragraphs: ["查詢、查閱、更正或刪除要求，請電郵 support@yi.rich-tide.com。我們可因服務或法律變更更新本政策，並在本頁標示新的生效日期。"] },
      ],
    },
    terms: {
      eyebrow: "服務界線",
      title: "使用條款",
      updated: "生效日期：2026 年 8 月 8 日",
      intro: "本條款是你與 RICHTIDE LIMITED 就使用 Yi · 易所訂的協議。使用服務即表示你同意本條款及私隱政策。",
      sections: [
        { title: "反思工具，不是專業建議", paragraphs: ["Yi 依固定規則產生卦象事實，並可在你同意後提供文化及反思用途的來源材料與 AI 內容。它不是預言，亦不提供醫療、心理健康、法律、金融、投資、安全或其他專業建議。請勿以服務取代合資格專業人士、緊急服務或你自己的判斷。"] },
        { title: "帳戶與可接受使用", paragraphs: ["儲存、筆記、搜尋及對話需要帳戶。你須提供準確資料、保障登入方式，並對帳戶活動負責。不得濫用服務、規避限制、干擾系統、侵犯他人權利、提交違法內容，或未經許可大量擷取來源目錄。"] },
        { title: "自願掛金", paragraphs: ["HK$0 可完成閱讀。HK$1-888 的正數款項是對數碼服務的自願掛金，不是慈善捐款。正數付款由 Stripe Checkout 處理，只有經驗證的 webhook 才確認付款及顯示結果。退款可向 support@yi.rich-tide.com 提出，並會按適用法律、付款狀態及具體情況處理。"] },
        { title: "AI、來源與用量", paragraphs: ["AI 是自願功能，受每日公平使用及全域預算限制。來源與翻譯經審核，但歷史文本可有版本差異；AI 亦可能不完整或出錯。確定性卦象不會由 AI 更改。服務可在供應商故障、安全路由或限額觸發時只提供確定性內容。"] },
        { title: "你的內容與服務材料", paragraphs: ["你保留對問題、筆記及對話內容所擁有的權利，並授予我們僅為營運、保安、支援、匯出及刪除服務所需的有限許可。應用程式、設計、品牌、程式及來源目錄受各自權利保護；除法律允許外，不得複製或重新分發。"] },
        { title: "可用性、終止及責任", paragraphs: ["服務按現狀及可用情況提供。我們可維護、變更或在合理需要時暫停功能；亦可為安全、濫用或違反條款而限制帳戶。你可隨時刪除帳戶。法律允許的最大範圍內，我們不對間接或相應損失負責；本條款不排除任何依法不能排除的權利或責任。"] },
        { title: "香港法律與聯絡", paragraphs: ["本條款受香港特別行政區法律管限，爭議由香港法院的非專屬司法管轄權處理。條款任何部分無效不影響其餘部分。查詢請電郵 support@yi.rich-tide.com。"] },
      ],
    },
  },
  "zh-CN": {
    ...
    privacy: {
      ...
      intro: "RICHTIDE LIMITED（“我们”）运营 Yi · 易。本政策说明我们收集哪些个人数据、使用原因、共享对象、保存时间，以及你可以如何行使选择和权利。",
      sections: [
        { title: "我们持有的数据", paragraphs: ["我们可能持有你的姓名、邮箱地址、登录及验证记录、语言与显示设置；你提交的问题、卦象事实、已保存阅读、笔记及对话；挂金金额、付款状态及 Stripe 标识符；联系表单内容；以及防滥用、错误及操作记录。完整支付卡数据由 Stripe 处理，我们不存储。"] },
        { title: "使用目的", paragraphs: ["我们使用数据来创建和保护账户、提供可重现阅读、保存你明确选择的内容、处理挂金、回复支持、执行用量及安全限制、检测滥用、维护服务，以及履行适用法律责任。我们不出售个人数据。"] },
        { title: "AI 由你选择", paragraphs: ["DeepSeek 反思是自愿功能。每次使用前，你分别选择是否发送卦象事实、已审核来源及原问题。高风险问题会绕过 AI。模型的隐藏推理不会返回或存储在浏览器。拒绝 AI 不影响确定性结果。"] },
        { title: "服务提供商与跨境处理", paragraphs: ["我们使用 Cloudflare 提供计算、数据库、安全及邮件；Better Auth 提供认证流程；Stripe 处理付款；Google 及 Microsoft 在你选择时提供登录；DeepSeek 只处理你明确同意发送的 AI 数据。这些提供商可能在香港以外处理数据，并受其条款及安全措施约束。我们也可能在法律要求或保护用户及服务所必要时披露数据。"] },
        { title: "保存与分享", paragraphs: ["未保存的访客阅读在七天内删除。匿名分享链接在七天后失效，且不含身份、原问题、笔记或对话。已保存阅读、笔记及对话保留至你逐项删除或关闭账户。操作错误记录通常在 90 天后删除。付款及必要审计数据可按法律、会计、争议及防欺诈需要保存更长时间。"] },
        { title: "安全、Cookie 与你的权利", paragraphs: ["我们使用同站 HTTP-only 会话、访问控制、加密传输及数据最小化。必要 Cookie 用于登录及安全；语言、主题及字体选择可存储在设备。你可在设置中导出或删除账户，也可要求访问或更正个人数据。为保护数据，我们可能核实申请人身份。"] },
        { title: "联系与更新", paragraphs: ["查询、访问、更正或删除请求，请发送邮件至 support@yi.rich-tide.com。我们可因服务或法律变化更新本政策，并在本页标示新的生效日期。"] },
      ],
    },
    terms: {
      eyebrow: "服务边界", title: "使用条款", updated: "生效日期：2026 年 8 月 8 日",
      intro: "本条款是你与 RICHTIDE LIMITED 就使用 Yi · 易订立的协议。使用服务即表示你同意本条款及隐私政策。",
      sections: [
        { title: "反思工具，不是专业建议", paragraphs: ["Yi 按固定规则生成卦象事实，并可在你同意后提供文化及反思用途的来源材料与 AI 内容。它不是预言，也不提供医疗、心理健康、法律、金融、投资、安全或其他专业建议。请勿以服务取代合格专业人士、紧急服务或你自己的判断。"] },
        { title: "账户与可接受使用", paragraphs: ["保存、笔记、搜索及对话需要账户。你须提供准确数据、保护登录方式，并对账户活动负责。不得滥用服务、规避限制、干扰系统、侵犯他人权利、提交违法内容，或未经许可批量提取来源目录。"] },
        { title: "自愿挂金", paragraphs: ["HK$0 可完成阅读。HK$1-888 的正数款项是对数字服务的自愿挂金，不是慈善捐款。正数付款由 Stripe Checkout 处理，只有经验证的 webhook 才确认付款及显示结果。退款可向 support@yi.rich-tide.com 提出，并会按适用法律、付款状态及具体情况处理。"] },
        { title: "AI、来源与用量", paragraphs: ["AI 是自愿功能，受每日公平使用及全局预算限制。来源与翻译经审核，但历史文本可能存在版本差异；AI 也可能不完整或出错。确定性卦象不会由 AI 更改。服务可在提供商故障、安全路由或限额触发时只提供确定性内容。"] },
        { title: "你的内容与服务材料", paragraphs: ["你保留对问题、笔记及对话内容所拥有的权利，并授予我们仅为运营、安全、支持、导出及删除服务所需的有限许可。应用程序、设计、品牌、程序及来源目录受各自权利保护；除法律允许外，不得复制或重新分发。"] },
        { title: "可用性、终止及责任", paragraphs: ["服务按现状及可用情况提供。我们可维护、变更或在合理需要时暂停功能；也可为安全、滥用或违反条款而限制账户。你可随时删除账户。在法律允许的最大范围内，我们不对间接或后果性损失负责；本条款不排除任何依法不能排除的权利或责任。"] },
        { title: "香港法律与联系", paragraphs: ["本条款受香港特别行政区法律管辖，争议由香港法院的非专属司法管辖权处理。条款任何部分无效不影响其余部分。查询请发送邮件至 support@yi.rich-tide.com。"] },
      ],
    },
  },
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "Contact and changes", paragraphs: ["For questions or access, correction and deletion requests, email support@yi.rich-tide.com. We may update this policy as the service or law changes and will identify the new effective date on this page."] },
      ],
    },
    terms: {
      ...
      sections: [
        ...
        { title: "Voluntary contributions", paragraphs: ["HK$0 completes a reading. Positive HK$1-888 amounts are voluntary contributions for the digital service, not charitable donations. Stripe Checkout processes positive payments; only a verified webhook confirms payment and releases the result. Refund requests may be sent to support@yi.rich-tide.com and are handled according to applicable law, payment status and the circumstances."] },
