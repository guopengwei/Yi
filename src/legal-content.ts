  ...
  "zh-HK": {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "聯絡與更新", paragraphs: ["查詢、查閱、更正或刪除要求，請電郵 contact@rich-tide.com。我們可因服務或法律變更更新本政策，並在本頁標示新的生效日期。"] },
      ],
    },
    terms: {
      eyebrow: "服務界線",
      ...
      sections: [
        ...
        { title: "自願掛金", paragraphs: ["HK$0 可完成閱讀。HK$1-888 的正數款項是對數碼服務的自願掛金，不是慈善捐款。正數付款由 Stripe Checkout 處理，只有經驗證的 webhook 才確認付款及顯示結果。退款可向 contact@rich-tide.com 提出，並會按適用法律、付款狀態及具體情況處理。"] },
        ...
        { title: "香港法律與聯絡", paragraphs: ["本條款受香港特別行政區法律管限，爭議由香港法院的非專屬司法管轄權處理。條款任何部分無效不影響其餘部分。查詢請電郵 contact@rich-tide.com。"] },
      ],
    },
  },
  "zh-CN": {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: "联系与更新", paragraphs: ["查询、访问、更正或删除请求，请发送邮件至 contact@rich-tide.com。我们可因服务或法律变化更新本政策，并在本页标示新的生效日期。"] },
      ],
    },
    terms: {
      ...
      sections: [
        ...
        { title: "自愿挂金", paragraphs: ["HK$0 可完成阅读。HK$1-888 的正数款项是对数字服务的自愿挂金，不是慈善捐款。正数付款由 Stripe Checkout 处理，只有经验证的 webhook 才确认付款及显示结果。退款可向 contact@rich-tide.com 提出，并会按适用法律、付款状态及具体情况处理。"] },
        ...
        { title: "香港法律与联系", paragraphs: ["本条款受香港特别行政区法律管辖，争议由香港法院的非专属司法管辖权处理。条款任何部分无效不影响其余部分。查询请发送邮件至 contact@rich-tide.com。"] },
      ],
    },
  },
  en: {
